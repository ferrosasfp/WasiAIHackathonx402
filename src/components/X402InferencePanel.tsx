...
// Chain configuration from shared constants
const CHAIN_ID = ACTIVE_CHAIN.chainId
const NETWORK = ACTIVE_CHAIN.network
const USDC_ADDRESS = process.env.NEXT_PUBLIC_X402_USDC_ADDRESS || getUsdcAddress(CHAIN_ID)
const USDC_DOMAIN = buildUsdcDomain(CHAIN_ID, USDC_ADDRESS)
...
export default function X402InferencePanel({
  ...
  const explorerUrl = txHash ? getExplorerTxUrl(txHash, CHAIN_ID) : null

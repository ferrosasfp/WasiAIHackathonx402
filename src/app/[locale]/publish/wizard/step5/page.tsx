        ...
        for (const tnet of targets) {
          try {
            ...
            const upgradePayload = {
              ...
              // Build demo object from step3 fields (inferenceConfig + downloadNotes)
              demo: {
                endpoint: step3.inferenceConfig?.endpoint || '',
                paymentWallet: step3.inferenceConfig?.paymentWallet || '',
                downloadNotes: step3.downloadNotes || ''
              },
            ...
            console.log('[Upgrade] Complete payload built:', {
              ...
              demo: upgradePayload.demo // Log full demo object to verify endpoint/wallet/downloadNotes
            })
            ...
            if (r.agentTxParams && modelId) {
              try {
                ...
                if (agentMetaData.ok && agentMetaData.uri) {
                  ...
                  // Update model in Neon DB with agentId
                  if (agentId) {
                    try {
                      await fetch('/api/indexed/models', {
                        method: 'POST',
                      ...
                      console.log(`[Wizard] ✅ Model #${modelId} updated with agentId ${agentId}`)
                    } catch (updateErr) {
                      console.warn('[Wizard] Failed to update model with agentId:', updateErr)
                    }
                  }
                }
              } catch (agentErr: any) {

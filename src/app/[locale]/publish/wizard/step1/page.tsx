    ...
    const loadExistingModel = async () => {
      try {
        ...
        const step3Data = {
          ...
          inferenceConfig: {
            endpoint: model.agent_endpoint || model.inference_endpoint || metadata.demo?.endpoint || metadata.inferenceConfig?.endpoint || '',
            paymentWallet: model.agent_wallet || model.inference_wallet || metadata.demo?.paymentWallet || metadata.inferenceConfig?.paymentWallet || ''
          }
        }

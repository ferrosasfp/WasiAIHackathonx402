...
import {
  ...
  Card, CardContent, CardHeader, Tooltip, IconButton, SvgIcon, Paper, Avatar,
    ...
    <Box sx={{ minHeight: '100vh', background: 'linear-gradient(180deg, #0f2740 0%, #0b1626 30%, #0a111c 100%)' }}>
      <Box sx={{
        ...
        {!loading && data && viewModel && (
          ...
          >
            ...
            <Paper 
              ...
              sx={{ 
                ...
                '&::before': {
                  ...
                  right: 0,
                  height: '4px',
                  background: 'linear-gradient(90deg, #7c5cff 0%, #4fe1ff 50%, #7c5cff 100%)',
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8}>
                  <Stack spacing={2.5}>
                    ...
                    {/* ⚡ RUN MODEL - Primary CTA Section */}
                    <Box sx={{ 
                      p: 2.5, 
                      borderRadius: 3, 
                      background: 'linear-gradient(135deg, rgba(79,225,255,0.12) 0%, rgba(124,92,255,0.12) 100%)',
                      border: '2px solid rgba(79,225,255,0.4)',
                      position: 'relative',
                      overflow: 'hidden',
                      '&::before': {
                        content: '""',
                        ...
                        right: 0,
                        height: '3px',
                        background: 'linear-gradient(90deg, #4fe1ff 0%, #7c5cff 50%, #4fe1ff 100%)',
                        backgroundSize: '200% 100%',
                      ...
                      <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2 }}>
                        <Box sx={{ 
                          ...
                          boxShadow: '0 4px 15px rgba(79,225,255,0.4)'
                        }}>
                          <Typography sx={{ fontSize: 24 }}>⚡</Typography>
                        </Box>
                        <Box>
                          <Typography variant="h6" sx={{ color: '#fff', fontWeight: 800, fontSize: '1.2rem', lineHeight: 1.2 }}>
                            {isES ? 'Ejecutar Modelo' : 'Run Model'}
                          </Typography>
                          <Typography variant="caption" sx={{ color: '#4fe1ff', fontWeight: 600 }}>
                            {isES ? 'Pago por uso • x402 Protocol' : 'Pay-per-use • x402 Protocol'}
                          </Typography>
                        </Box>
                      </Stack>
                      
                      <Typography variant="body2" sx={{ color: '#ffffffcc', mb: 2, lineHeight: 1.5 }}>
                        {isES 
                          ? 'Prueba el modelo al instante. Paga solo por lo que usas con micropagos en USDC.' 
                          : 'Try the model instantly. Pay only for what you use with USDC micropayments.'}
                      </Typography>
                      ...
                      <Button 
                        ...
                        sx={{ 
                          ...
                          py: 1.75,
                          borderRadius: 2,
                          boxShadow: '0 8px 24px rgba(79,225,255,0.4)',
                          '&:hover': { 
                            background: 'linear-gradient(135deg, #6ee7ff 0%, #22c5e0 100%)',
                            boxShadow: '0 12px 32px rgba(79,225,255,0.5)',
                            transform: 'translateY(-2px)'
                          },
                          transition: 'all 0.25s ease'
                        }}
                      >
                        ⚡ {isES ? 'Ejecutar Modelo Ahora' : 'Run Model Now'}
                      </Button>
                    </Box>
                    ...
                    {/* 📜 LICENSE - Secondary Section (Collapsible style) */}
                      ...
                      <Box sx={{ 
                        ...
                        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1.5 }}>
                          <Stack direction="row" spacing={1} alignItems="center">
                            ...
                            <Typography variant="subtitle2" sx={{ color: '#ffffffcc', fontWeight: 600 }}>
                              {isES ? 'Licencia Perpetua' : 'Perpetual License'}
                            </Typography>
                          </Stack>
                          <Chip 
                            label={`${viewModel?.step4?.pricing?.perpetual?.priceFormatted || formatPrice(data?.price_perpetual)} ${evmSymbol}`}
                            size="small"
                            sx={{ 
                              bgcolor: 'rgba(124,92,255,0.15)', 
                              color: '#b8a3ff', 
                        ...
                        <Stack direction="row" spacing={0.75} sx={{ flexWrap: 'wrap', gap: 0.5, mb: 1.5 }}>
                          {viewModel?.step4?.rights?.canUseAPI && (
                            <Chip label="API" size="small" sx={{ bgcolor: 'rgba(255,255,255,0.06)', color: '#ffffff99', fontSize: '0.7rem', height: 20 }} />
                          )}
                          {viewModel?.step4?.rights?.canDownload && (
                            <Chip label={isES ? 'Descarga' : 'Download'} size="small" sx={{ bgcolor: 'rgba(255,255,255,0.06)', color: '#ffffff99', fontSize: '0.7rem', height: 20 }} />
                          )}
                          <Chip label="NFT" size="small" sx={{ bgcolor: 'rgba(255,255,255,0.06)', color: '#ffffff99', fontSize: '0.7rem', height: 20 }} />
                          <Chip label={isES ? 'De por vida' : 'Lifetime'} size="small" sx={{ bgcolor: 'rgba(255,255,255,0.06)', color: '#ffffff99', fontSize: '0.7rem', height: 20 }} />
                        </Stack>
                        ...
                        {hasActiveLicense && (
                          ...
                          >
                            {locale === 'es' ? 'Ya tienes una licencia activa' : 'You already hold an active license'}
                          </Alert>
                        )}
                  ...
                  <Stack spacing={2}>
                    ...
                    {viewModel.step1.cover?.cid || data.imageUrl ? (
                      ...
                      <Box sx={{
                        ...
                        <CodeIcon sx={{ fontSize: 40, color: 'rgba(124,92,255,0.5)' }} />
            ...
            {/* ⚡ RUN MODEL SECTION - Primary Focus Area */}
            <Paper 
              ref={demoAnchorRef}
              variant="outlined" 
              sx={{ 
                ...
                mb: 3, 
                borderRadius: 3, 
                bgcolor: 'rgba(79,225,255,0.03)',
                border: '2px solid rgba(79,225,255,0.25)',
                position: 'relative',
                overflow: 'hidden',
                '&::before': {
                  content: '""',
                  ...
                  background: 'linear-gradient(90deg, #4fe1ff 0%, #7c5cff 50%, #4fe1ff 100%)',
                  backgroundSize: '200% 100%',
                  animation: 'shimmerRun 2.5s ease-in-out infinite',
                },
                ...
                '&::after': {
                  ...
                  width: '250px',
                  height: '250px',
                  background: 'radial-gradient(circle, rgba(79,225,255,0.1) 0%, transparent 70%)',
                  pointerEvents: 'none',
                }
              }}
            >
              ...
              <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 3 }}>
                <Avatar sx={{ 
                  ...
                  height: 48, 
                  background: 'linear-gradient(135deg, #4fe1ff 0%, #00b4d8 100%)',
                  boxShadow: '0 6px 20px rgba(79,225,255,0.4)'
                }}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" sx={{ color: '#4fe1ff', fontWeight: 500 }}>
                    {isES ? 'Pago por uso con x402 Protocol • Micropagos en USDC' : 'Pay-per-use with x402 Protocol • USDC micropayments'}
                  </Typography>
                </Box>
              </Stack>

              {/* x402 Inference Panel */}
              {(() => {
                ...
                const showX402 = ['14', '20', '23'].includes(String(id)) || !!pricePerCall || true // Always show for demo
                return showX402 ? (
                  <Box sx={{ mb: 3 }}>
                    <X402InferencePanel
                      modelId={id}
              ...
              <Box>
                <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2 }}>
                  <Avatar sx={{ 
                    ...
                    <DescriptionIcon sx={{ fontSize: 18, color: '#4fe1ff' }} />
                  </Avatar>
                  <Typography variant="subtitle1" sx={{ color: '#fff', fontWeight: 700 }}>
                    {isES ? 'Ejecuciones Recientes' : 'Recent Runs'}
                  </Typography>
                </Stack>
                <InferenceHistory
                  modelId={id}
            ...
            <Paper 
              ...
              sx={{ 
                ...
                transition: 'all 0.3s ease',
                '&:hover': {
                  borderColor: 'rgba(79,225,255,0.3)',
                  boxShadow: '0 8px 32px rgba(79,225,255,0.1)',
                },
                '&::before': {
                  content: '""',
                  position: 'absolute',
                  ...
                  width: '4px',
                  height: '100%',
                  background: 'linear-gradient(180deg, #4fe1ff 0%, #7c5cff 100%)',
                }
              }}
            >
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb:2.5 }}>
                <Avatar sx={{ 
                  ...
                  height: 36, 
                  background: 'linear-gradient(135deg, #4fe1ff 0%, #00b4d8 100%)',
                  boxShadow: '0 4px 12px rgba(79,225,255,0.3)'
                }}>
            ...
            {/* Technical Configuration - Enhanced */}
            <Paper 
              variant="outlined" 
              sx={{ 
                p:{ xs:2, md:3 }, 
                ...
                '&:hover': {
                  borderColor: 'rgba(124,92,255,0.3)',
                  boxShadow: '0 8px 32px rgba(124,92,255,0.1)',
                },
                '&::before': {
                  content: '""',
                  position: 'absolute',
            ...
            {/* Published by - Author section - Enhanced */}
            <Paper 
              variant="outlined" 
              sx={{ 
                p:{ xs:2, md:3 }, 
            ...
            >
              ...
              <Stack direction="row" spacing={2} alignItems="center">
                ...
                <Box sx={{ 
                  ...
                  height:64, 
                  borderRadius:'50%', 
                  background: 'linear-gradient(135deg, rgba(124,92,255,0.3) 0%, rgba(79,225,255,0.3) 100%)', 
      ...
      <Dialog
        ...
        PaperProps={{
          sx: {
            ...
            background: 'linear-gradient(180deg, rgba(30,36,54,0.98) 0%, rgba(16,20,32,0.98) 100%)',
      ...
      >
        ...
        <Box sx={{ 
          ...
          background: 'linear-gradient(90deg, rgba(124,92,255,0.1) 0%, rgba(46,160,255,0.1) 100%)'
        }}>
          ...
          <IconButton 
            onClick={()=> { setBuyOpen(false); setBuyStep('select'); setBuyKind(undefined); }}
            sx={{ 
            ...
            <Stack spacing={2} sx={{ p: 3 }}>
              ...
              <Box>
                ...
                <RadioGroup row value={buyKind || ''} onChange={(e)=> setBuyKind((e.target as HTMLInputElement).value as any)}>
                  <FormControlLabel
                    value="perpetual"
                    control={<Radio sx={{ color:'#ffffffb3', '&.Mui-checked': { color:'#7c5cff' } }} />}
                    label={L.perpetual}
                    sx={{ color:'#fff' }}
                  />
                  <FormControlLabel
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <Card sx={{ borderRadius: 2, border:'1px solid', borderColor: buyKind==='perpetual' ? '#7c5cff' : 'rgba(255,255,255,0.18)', background:'rgba(255,255,255,0.06)', transition: 'all 0.2s' }}>
                    <CardContent>
                ...
                <Grid item xs={12} sm={6}>
                  <Card sx={{ borderRadius: 2, border:'1px solid', borderColor: buyKind==='subscription' ? '#7c5cff' : 'rgba(255,255,255,0.18)', background:'rgba(255,255,255,0.06)', transition: 'all 0.2s' }}>
                    <CardContent>
          ...
          {buyStep === 'review' && (
            <Box>
              ...
              <Box sx={{ p: 3, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                <Stack direction="row" spacing={2} alignItems="center">
                  {(viewModel?.step1?.cover?.cid || data?.cover_uri) ? (
                    <Box sx={{ 
                      width: 64, 
                      height: 64, 
                      borderRadius: '12px', 
                      ...
                      <IpfsImage 
                        cid={viewModel?.step1?.cover?.cid || data?.cover_uri?.replace('ipfs://', '')} 
                        alt={data?.name || 'Model'} 
                        width={64}
                        height={64}
                        objectFit="cover"
                  ...
                  <Box sx={{ flex: 1, minWidth: 0 }}>
                    <Typography variant="subtitle1" sx={{ color: '#fff', fontWeight: 700, mb: 0.25 }} noWrap>
                      {data?.name || 'AI Model'}
                    </Typography>
                    <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', display: 'block' }} noWrap>
                      {isES ? 'por' : 'by'} {data?.owner ? `${data.owner.slice(0,6)}...${data.owner.slice(-4)}` : 'Unknown'}
                    </Typography>
                    <Chip 
                      label={isES ? 'Licencia Perpetua' : 'Perpetual License'} 
                      size="small" 
              ...
              {/* License benefits */}
              <Box sx={{ p: 3, borderBottom: '1px solid rgba(255,255,255,0.06)', bgcolor: 'rgba(255,255,255,0.02)' }}>
                <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: 1, display: 'block', mb: 1.5 }}>
                  {isES ? 'Incluido en tu licencia' : 'Included in your license'}
                </Typography>
                <Stack spacing={1.5}>
                  <Stack direction="row" spacing={1.5} alignItems="center">
                    <AllInclusiveIcon sx={{ color: '#4fe1ff', fontSize: 18 }} />
                    <Typography variant="body2" sx={{ color: '#fff' }}>
                      {isES ? 'Acceso de por vida al modelo' : 'Lifetime access to the model'}
                    </Typography>
                  </Stack>
                  <Stack direction="row" spacing={1.5} alignItems="center">
                    <VerifiedUserIcon sx={{ color: '#4fe1ff', fontSize: 18 }} />
                    <Typography variant="body2" sx={{ color: '#fff' }}>
                      {isES ? 'Licencia NFT verificable on-chain' : 'Verifiable on-chain NFT license'}
                    </Typography>
                  </Stack>
                  <Stack direction="row" spacing={1.5} alignItems="center">
                    <SecurityIcon sx={{ color: '#4fe1ff', fontSize: 18 }} />
                    <Typography variant="body2" sx={{ color: '#fff' }}>
                      {isES ? 'Transacción segura con USDC' : 'Secure transaction with USDC'}
                    </Typography>
                  </Stack>
                </Stack>
              </Box>
              ...
              {/* Price summary */}
              <Box sx={{ p: 3 }}>
                <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: 1, display: 'block', mb: 2 }}>
                  {isES ? 'Resumen del pago' : 'Payment Summary'}
                </Typography>
                ...
                <Stack spacing={1.5}>
                  <Stack direction="row" justifyContent="space-between" alignItems="center">
                    ...
                    <Typography variant="body2" sx={{ color: '#fff' }}>
                      {buyKind === 'perpetual' 
                        ? `${formatPrice(data?.price_perpetual)} ${evmSymbol}`
                        : buyKind === 'subscription' && data?.price_subscription
                          ? `${formatPrice(data.price_subscription)} ${evmSymbol} × ${buyMonths}`
                          : '-'
                      }
                    </Typography>
                  </Stack>
                ...
                <Box sx={{ 
                  ...
                  <Stack direction="row" spacing={1.5} alignItems="center">
                    <AccountBalanceWalletIcon sx={{ color: 'rgba(255,255,255,0.5)', fontSize: 18 }} />
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', display: 'block' }}>
                        {isES ? 'Pagar desde' : 'Pay from'}
                      </Typography>
                      <Typography variant="body2" sx={{ color: '#fff', fontFamily: 'monospace', fontSize: '0.8rem' }} noWrap>
                        {walletAddress ? `${walletAddress.slice(0,8)}...${walletAddress.slice(-6)}` : (isES ? 'Wallet no conectada' : 'Wallet not connected')}
                      </Typography>
                    </Box>
                  </Stack>
                </Box>
          ...
          {buyStep === 'review' ? (
            <Stack direction="row" spacing={2}>
              ...
              <Button 
                ...
                disabled={txLoading} 
                startIcon={txLoading ? <CircularProgress size={18} sx={{ color: '#fff' }} /> : <ShoppingCartIcon />}
                sx={{ 
                  background: 'linear-gradient(135deg, #7c5cff 0%, #2ea0ff 100%)',
                  color: '#fff', 
                  fontWeight: 700,
              ...
              >
                {txLoading ? (isES ? 'Procesando...' : 'Processing...') : (isES ? 'Confirmar compra' : 'Confirm Purchase')}
              </Button>
            </Stack>
          ) : (
            <Stack direction="row" spacing={2}>
